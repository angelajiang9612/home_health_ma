...
//check what missing values mean for these variables 
...
//for every year of data, remove the highest percentile (outliers mostly due to misreporting)

foreach var in `types' {
	sum `var'_visits_pi_xviii 
	sum `var'_visits_pi_others if year>=2010, detail 
}


//at this point no zero, only missing
foreach var in `types' {
...
//replace some of the missings by zero, leave the ones with visits info but no patient info or vice versa as missing 
foreach var in `types' {
...
//create visits per patient for Medicare traditional and others 
...
replace state = "AS" if inlist(state,)
replace state = "CA" if inlist(state,"C.A."," CA.","CALFORNIA","CALIF","CALIFORNIA")
replace state = "CO" if inlist(state,"COLORADO")
replace state = "CT" if inlist(state,)
replace state = "DE" if inlist(state,)
replace state = "DC" if inlist(state,)
replace state = "FL" if inlist(state,"FL.","FLORIDA","FT. LAUDERDALE")
replace state = "GA" if inlist(state,"GA.","GARRGIA","GEORGIA")
replace state = "GU" if inlist(state,)
...
replace state = "IN" if inlist(state,)
replace state = "IA" if inlist(state,)
replace state = "KS" if inlist(state,)
replace state = "KY" if inlist(state,)
replace state = "LA" if inlist(state,)
replace state = "ME" if inlist(state,)
replace state = "MD" if inlist(state,)
replace state = "MA" if inlist(state,)
replace state = "MI" if inlist(state,)
replace state = "MN" if inlist(state,)
replace state = "MS" if inlist(state,)
replace state = "MO" if inlist(state,)
replace state = "MT" if inlist(state,)
replace state = "NE" if inlist(state,)
replace state = "NV" if inlist(state,)
replace state = "NH" if inlist(state,)
replace state = "NJ" if inlist(state,)
replace state = "NM" if inlist(state,)
replace state = "NY" if inlist(state,)
replace state = "NC" if inlist(state,)
replace state = "ND" if inlist(state,)
replace state = "MP" if inlist(state,)
replace state = "OH" if inlist(state,"CLEVELAND")
replace state = "OK" if inlist(state,)
replace state = "OR" if inlist(state,)
replace state = "PA" if inlist(state,)
replace state = "PR" if inlist(state,)
replace state = "RI" if inlist(state,)
replace state = "SC" if inlist(state,)
replace state = "SD" if inlist(state,)
replace state = "TN" if inlist(state,)
replace state = "TX" if inlist(state,)
replace state = "TT" if inlist(state,)
replace state = "UT" if inlist(state,)
replace state = "VT" if inlist(state,)
replace state = "VA" if inlist(state,)
replace state = "VI" if inlist(state,)
replace state = "WA" if inlist(state,)
replace state = "WV" if inlist(state,)
replace state = "WI" if inlist(state,)
replace state = "WY" if inlist(state,)


replace by missing in all other cases?
