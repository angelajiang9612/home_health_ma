...
forvalues i = 1994 { //stop at 2019 for now, 2020 onwards new data format 
	...
	drop wksht_cd line_num clmn_num //need to drop these because they are not constant within 
	...
	destring rpt_rec_num, replace 
	merge 1:1 rpt_rec_num using `nmrc_`i'' //not everything in master is matched, check reason 
	drop _merge 
