...
log using MA_entry_01_18.log, replace 
...
reg n_firms penetration `controls' i.county_id i.year 

reg n_entrants penetration `controls' i.county_id i.year 

reg n_exits penetration `controls' i.county_id i.year 

poisson n_firms penetration `controls' i.county_id i.year 

poisson n_entrants penetration `controls' i.county_id i.year 

poisson n_exits penetration `controls' i.county_id i.year 
...
//show main results as clustered on county level 
